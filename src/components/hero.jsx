  ...
  return (
    ...
    >
        ...
        <h1 className='text-4xl md:text-6xl font-bold mb-4'>
            Hi,I'm <span className='text-purple'>Roshan Ambilwade</span>
        </h1>
        <h2 className='text-2xl md:text-4xl font-semibold mb-6 typewriter'>Full Stack Developer</h2>
        <p className='text-lg text-gray-300 mb-8'>I am an Information Technology student and MERN Stack Developer passionate about building modern, scalable, and user-friendly web applications using React, Node.js, and MongoDB.</p>
